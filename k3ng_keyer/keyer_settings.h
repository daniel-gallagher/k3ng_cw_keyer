...
#define FEATURE_ETHERNET_IP \
  {                         \
    192, 168, 1, 179        \
  } // default IP address ("192.168.1.179")
#define FEATURE_ETHERNET_MAC           \
  {                                    \
    0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0xEE \
  }
#define FEATURE_ETHERNET_DNS \
  {                          \
    8, 8, 8, 8               \
  }

#define FEATURE_ETHERNET_GATEWAY \
  {                              \
    192, 168, 1, 1               \
  } // default gateway
#define FEATURE_ETHERNET_SUBNET_MASK \
  {                                  \
    255, 255, 255, 0                 \
  } // default subnet mask
...
char HI_TEXT[] = "HI"; // Must be in UPPER case
